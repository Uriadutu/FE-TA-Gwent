...
const AddGenreModal = ({ setIsOpenModalAdd, getGenre }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post("http://localhost:8000/genres", {
        nama: namaGenre.trim(),
      });
  ...
  return (
    <ModalPortal>
      <div className="fixed z-[999] inset-0 px-2 flex items-center sm:items-start sm:pt-3 justify-center bg-black bg-opacity-60">
